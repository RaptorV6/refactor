...
import { useFormInitialData, usePreviewData } from "./new-application-form-rtg-loaders";
...
export const enumContrastAgentAllergy = {
  ANO: "ANO" as const,
  NE: "NE" as const,
};
...
const baseSchema = v.object({
  ...
  contrastAgentAllergy: v.nullable(v.enum_(enumContrastAgentAllergy, "Vyberte ANO / NE")),
...
export const NewApplicationFormRtgForm = component$(() => {
  ...
  const contrastAgentAllergy: Record<string, string> = {
    ANO: "ANO",
    NE: "NE",
  };
        ...
        <Card>
          ...
          <CardBody>
            ...
            <FieldRadio
              ...
              name="contrastAgentAllergy"
              of={formStore}
              options={Object.entries(contrastAgentAllergy).map(([value, label]) => ({
                label,
                value,
              }))}
            />
